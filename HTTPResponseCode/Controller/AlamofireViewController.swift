...
class AlamofireViewController: UIViewController {
    ...
    @IBAction func testURLbutton(_ sender: Any) {
        ...
        // Le "completion handler" est une closure échappée (@escaping), avec la liste de capture [weak self] pour éviter la fuite de mémoire
        NetworkService.shared.HTTPRequestAlamofire(from: url, completion: { [weak self] responseStatus in
